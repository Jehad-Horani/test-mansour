...
export default function HelpPage() {
  ...
  const faqCategories = [
    ...
    },
    {
      ...
      questions: [
        {
          q: "كيف أحجز استشارة مع سفير؟",
          a: "اذهب إلى صفحة السفراء، اختر السفير المناسب واضغط 'احجز استشارة' واختر الوقت المناسب.",
        },
        {
          q: "كم تكلفة الاستشارة؟",
          a: "تختلف التكلفة حسب السفير والتخصص، وتتراوح بين 50-200 ريال للجلسة الواحدة.",
        },
        {
