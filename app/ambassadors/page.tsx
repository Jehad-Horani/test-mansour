                ...
                <div key={ambassador.id} className="retro-window bg-white">
                  <div className="p-6">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <h3 className="font-bold text-xl mb-2 text-gray-800">السفير :{ambassador.name}</h3>
                      <div className="space-y-1">
                        <p className="text-lg font-semibold text-blue-600">التخصص :{ambassador.major}</p>
                        <p className="text-sm text-gray-600">الجامعة :{ambassador.university}</p>
                      </div>
                    </div>
